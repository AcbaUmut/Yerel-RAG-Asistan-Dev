...
class VLMEngine:
    ...
    def _build_prompt() -> str:
        return (
            ...
            "- Tablo varsa Markdown tablosu olarak çiz. Tablo başlığı birden fazla "
            "satıra yayılmışsa (üst başlık + alt başlıklar) veya bir başlığın altında "
            "birden fazla sütun varsa, her gerçek sütun için 'ÜstBaşlık - AltBaşlık' "
            "formatında tek satırlık bir başlık üret. Veri satırındaki hücre sayısı, "
            "başlık satırındaki sütun sayısıyla aynı olmalı; görselde boş hücre varsa "
            "yerine tire (-) koy, atlama. Tablo içine not, açıklama veya dipnot satırı "
            "ekleme.\n"
